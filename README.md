...
## HTTP logging recovery

See `HTTP_LOGGING_TROUBLESHOOTING.md` for the validated mitmproxy/DVWA permission diagnosis, permanent installer fix, and acceptance test.
