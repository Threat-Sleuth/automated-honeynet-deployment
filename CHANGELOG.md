...
- Corrected the WireGuard container dependency from the unavailable `ghcr.io/wg-easy/wg-easy:14.0.0` tag to the published `ghcr.io/wg-easy/wg-easy:15.1` tag.
