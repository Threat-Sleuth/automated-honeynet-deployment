...
## Fluentd startup compatibility

Services using Docker's Fluentd logging driver are configured with the supported option:

```yaml
fluentd-async: "true"
```

This permits asynchronous connection to Fluentd during the initial stack startup.
