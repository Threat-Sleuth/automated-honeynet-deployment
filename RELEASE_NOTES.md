...
- Both WireGuard services use the published `ghcr.io/wg-easy/wg-easy:15.1` image tag.
- Distribution checksums were regenerated after rebuilding `honeynet.tar.gz`.
