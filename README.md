...
6. creates clean mail-state and WireGuard runtime directories;
...
The corresponding bcrypt hashes are stored only in `compose.yml`; no separate credential-state file is included.
